        ...
        <>
            {
                ...
                <Link href={collectionHref}>
                    <figure className={`relative flex flex-col items-left text-white mx-2.5 mb-5 border-black hover:border-[#777] border col-span-1 sm:col-span-${gridCols} transition-all duration-300 cursor-pointer filter grayscale hover:grayscale-0`}>
                        <img className={`max-w-[1050px] max-h-[400px]`} src={imgPath} height="auto"/>
